    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.targets.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="target_name" id="target_name" value="{{ old('target_name', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            @foreach(Domains\Targets\Models\Target::TARGET_STATUS_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="target_status_{{ $key }}" name="target_status" value="{{ $key }}" {{ old('target_status', '0') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="first_pay_date" id="first_pay_date" value="{{ old('first_pay_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="monthly_pay_amount" id="monthly_pay_amount" value="{{ old('monthly_pay_amount', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="pay_to_date" id="pay_to_date" value="{{ old('pay_to_date') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="target_is_done" id="target_is_done" value="1" {{ old('target_is_done', 0) == 1 ? 'checked' : '' }}>

                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.currencies.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="course" id="course" value="{{ old('course', '1') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="update_date" id="update_date" value="{{ old('update_date') }}">

    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.accounts-extras.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="card_expire_date" id="card_expire_date" value="{{ old('card_expire_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_year_cost" id="card_year_cost" value="{{ old('card_year_cost', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_rate_balance" id="card_rate_balance" value="{{ old('card_rate_balance', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_atm_commission" id="card_atm_commission" value="{{ old('card_atm_commission', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_other_atm_commission" id="card_other_atm_commission" value="{{ old('card_other_atm_commission', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_limit" id="card_credit_limit" value="{{ old('card_credit_limit', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_interest_rate" id="card_credit_interest_rate" value="{{ old('card_credit_interest_rate', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_grace_period" id="card_credit_grace_period" value="{{ old('card_credit_grace_period', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_min_payment_percent" id="card_credit_min_payment_percent" value="{{ old('card_credit_min_payment_percent', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_min_payment_day" id="card_credit_min_payment_day" value="{{ old('card_credit_min_payment_day', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_annual_service_cost" id="card_credit_annual_service_cost" value="{{ old('card_credit_annual_service_cost', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="account_open_date" id="account_open_date" value="{{ old('account_open_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_interest_rate" id="account_interest_rate" value="{{ old('account_interest_rate', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="account_close_date" id="account_close_date" value="{{ old('account_close_date') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="account_is_capitalization" id="account_is_capitalization" value="1" {{ old('account_is_capitalization', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_credit_one_time_commission" id="account_credit_one_time_commission" value="{{ old('account_credit_one_time_commission', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_credit_monthly_commission" id="account_credit_monthly_commission" value="{{ old('account_credit_monthly_commission', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_credit_payment_day" id="account_credit_payment_day" value="{{ old('account_credit_payment_day', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="loan_give_date" id="loan_give_date" value="{{ old('loan_give_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="loan_take_date" id="loan_take_date" value="{{ old('loan_take_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="loan_debitor_email" id="loan_debitor_email" value="{{ old('loan_debitor_email') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="loan_debitor_phone" id="loan_debitor_phone" value="{{ old('loan_debitor_phone', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="loan_interest_rate" id="loan_interest_rate" value="{{ old('loan_interest_rate', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_living_space" id="immovables_living_space" value="{{ old('immovables_living_space', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_usable_space" id="immovables_usable_space" value="{{ old('immovables_usable_space', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_landing_plot" id="immovables_landing_plot" value="{{ old('immovables_landing_plot', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_distance_to_city" id="immovables_distance_to_city" value="{{ old('immovables_distance_to_city', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_floor" id="immovables_floor" value="{{ old('immovables_floor', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_count_floor" id="immovables_count_floor" value="{{ old('immovables_count_floor', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="immovables_city" id="immovables_city" value="{{ old('immovables_city', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="immovables_district" id="immovables_district" value="{{ old('immovables_district', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="immovables_purchase_date" id="immovables_purchase_date" value="{{ old('immovables_purchase_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_transport_type" id="auto_transport_type" value="{{ old('auto_transport_type', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_model" id="auto_model" value="{{ old('auto_model', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_modification" id="auto_modification" value="{{ old('auto_modification', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_color" id="auto_color" value="{{ old('auto_color', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="auto_year" id="auto_year" value="{{ old('auto_year', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="auto_engine_size" id="auto_engine_size" value="{{ old('auto_engine_size', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_region" id="auto_region" value="{{ old('auto_region', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="auto_mileage" id="auto_mileage" value="{{ old('auto_mileage', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="auto_purchase_date" id="auto_purchase_date" value="{{ old('auto_purchase_date') }}">

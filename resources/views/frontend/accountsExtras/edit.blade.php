    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.accounts-extras.update", [$accountsExtra->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="card_type_id">{{ trans('cruds.accountsExtra.fields.card_type') }}</label>
                            <select class="form-control select2" name="card_type_id" id="card_type_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="card_expire_date" id="card_expire_date" value="{{ old('card_expire_date', $accountsExtra->card_expire_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_year_cost" id="card_year_cost" value="{{ old('card_year_cost', $accountsExtra->card_year_cost) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_rate_balance" id="card_rate_balance" value="{{ old('card_rate_balance', $accountsExtra->card_rate_balance) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_atm_commission" id="card_atm_commission" value="{{ old('card_atm_commission', $accountsExtra->card_atm_commission) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_other_atm_commission" id="card_other_atm_commission" value="{{ old('card_other_atm_commission', $accountsExtra->card_other_atm_commission) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_limit" id="card_credit_limit" value="{{ old('card_credit_limit', $accountsExtra->card_credit_limit) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_interest_rate" id="card_credit_interest_rate" value="{{ old('card_credit_interest_rate', $accountsExtra->card_credit_interest_rate) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_grace_period" id="card_credit_grace_period" value="{{ old('card_credit_grace_period', $accountsExtra->card_credit_grace_period) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_min_payment_percent" id="card_credit_min_payment_percent" value="{{ old('card_credit_min_payment_percent', $accountsExtra->card_credit_min_payment_percent) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_min_payment_day" id="card_credit_min_payment_day" value="{{ old('card_credit_min_payment_day', $accountsExtra->card_credit_min_payment_day) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="card_credit_annual_service_cost" id="card_credit_annual_service_cost" value="{{ old('card_credit_annual_service_cost', $accountsExtra->card_credit_annual_service_cost) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="account_open_date" id="account_open_date" value="{{ old('account_open_date', $accountsExtra->account_open_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_interest_rate" id="account_interest_rate" value="{{ old('account_interest_rate', $accountsExtra->account_interest_rate) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="account_close_date" id="account_close_date" value="{{ old('account_close_date', $accountsExtra->account_close_date) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="account_is_capitalization" id="account_is_capitalization" value="1" {{ $accountsExtra->account_is_capitalization || old('account_is_capitalization', 0) === 1 ? 'checked' : '' }}>
                                <label for="account_is_capitalization">{{ trans('cruds.accountsExtra.fields.account_is_capitalization') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="account_interest_period" id="account_interest_period">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="account_deposit_type" id="account_deposit_type">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="account_credit_payment_type" id="account_credit_payment_type">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_credit_one_time_commission" id="account_credit_one_time_commission" value="{{ old('account_credit_one_time_commission', $accountsExtra->account_credit_one_time_commission) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_credit_monthly_commission" id="account_credit_monthly_commission" value="{{ old('account_credit_monthly_commission', $accountsExtra->account_credit_monthly_commission) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="account_credit_payment_day" id="account_credit_payment_day" value="{{ old('account_credit_payment_day', $accountsExtra->account_credit_payment_day) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="loan_give_date" id="loan_give_date" value="{{ old('loan_give_date', $accountsExtra->loan_give_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="loan_take_date" id="loan_take_date" value="{{ old('loan_take_date', $accountsExtra->loan_take_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="loan_debitor_email" id="loan_debitor_email" value="{{ old('loan_debitor_email', $accountsExtra->loan_debitor_email) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="loan_debitor_phone" id="loan_debitor_phone" value="{{ old('loan_debitor_phone', $accountsExtra->loan_debitor_phone) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="loan_interest_rate" id="loan_interest_rate" value="{{ old('loan_interest_rate', $accountsExtra->loan_interest_rate) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="immovables_estate_type" id="immovables_estate_type">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_living_space" id="immovables_living_space" value="{{ old('immovables_living_space', $accountsExtra->immovables_living_space) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_usable_space" id="immovables_usable_space" value="{{ old('immovables_usable_space', $accountsExtra->immovables_usable_space) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_landing_plot" id="immovables_landing_plot" value="{{ old('immovables_landing_plot', $accountsExtra->immovables_landing_plot) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_distance_to_city" id="immovables_distance_to_city" value="{{ old('immovables_distance_to_city', $accountsExtra->immovables_distance_to_city) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_floor" id="immovables_floor" value="{{ old('immovables_floor', $accountsExtra->immovables_floor) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="immovables_count_floor" id="immovables_count_floor" value="{{ old('immovables_count_floor', $accountsExtra->immovables_count_floor) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="immovables_city" id="immovables_city" value="{{ old('immovables_city', $accountsExtra->immovables_city) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="immovables_district" id="immovables_district" value="{{ old('immovables_district', $accountsExtra->immovables_district) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="immovables_purchase_date" id="immovables_purchase_date" value="{{ old('immovables_purchase_date', $accountsExtra->immovables_purchase_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_transport_type" id="auto_transport_type" value="{{ old('auto_transport_type', $accountsExtra->auto_transport_type) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="auto_brand_id" id="auto_brand_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_model" id="auto_model" value="{{ old('auto_model', $accountsExtra->auto_model) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_modification" id="auto_modification" value="{{ old('auto_modification', $accountsExtra->auto_modification) }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="auto_fuel_type" id="auto_fuel_type">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="auto_transmission_type" id="auto_transmission_type">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_color" id="auto_color" value="{{ old('auto_color', $accountsExtra->auto_color) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="auto_year" id="auto_year" value="{{ old('auto_year', $accountsExtra->auto_year) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="auto_engine_size" id="auto_engine_size" value="{{ old('auto_engine_size', $accountsExtra->auto_engine_size) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="auto_region" id="auto_region" value="{{ old('auto_region', $accountsExtra->auto_region) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="auto_mileage" id="auto_mileage" value="{{ old('auto_mileage', $accountsExtra->auto_mileage) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="auto_purchase_date" id="auto_purchase_date" value="{{ old('auto_purchase_date', $accountsExtra->auto_purchase_date) }}">

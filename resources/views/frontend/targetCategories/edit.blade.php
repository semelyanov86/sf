    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.target-categories.update", [$targetCategory->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="target_category_name">{{ trans('cruds.targetCategory.fields.target_category_name') }}</label>
                            <input class="form-control" type="text" name="target_category_name" id="target_category_name" value="{{ old('target_category_name', $targetCategory->target_category_name) }}" required>

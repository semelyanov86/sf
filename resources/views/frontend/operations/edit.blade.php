    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.operations.update", [$operation->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="amount">{{ trans('cruds.operation.fields.amount') }}</label>
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $operation->amount) }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="done_at" id="done_at" value="{{ old('done_at', $operation->done_at) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description', $operation->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="related_transactions" id="related_transactions">{{ old('related_transactions', $operation->related_transactions) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cal_repeat" id="cal_repeat" value="{{ old('cal_repeat', $operation->cal_repeat) }}" step="1">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="google_sync" id="google_sync" value="1" {{ $operation->google_sync || old('google_sync', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="remind_operation" id="remind_operation" value="1" {{ $operation->remind_operation || old('remind_operation', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_calendar" id="is_calendar" value="1" {{ $operation->is_calendar || old('is_calendar', 0) === 1 ? 'checked' : '' }}>

                    ...
                    <form method="POST" action="{{ route("frontend.categories.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_hidden" id="is_hidden" value="1" {{ old('is_hidden', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sys_category" id="sys_category" value="{{ old('sys_category', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="last_used_at" id="last_used_at" value="{{ old('last_used_at') }}">

    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.accounts.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Account::STATE_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="state_{{ $key }}" name="state" value="{{ $key }}" {{ old('state', '0') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="start_balance" id="start_balance" value="{{ old('start_balance', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="market_value" id="market_value" value="{{ old('market_value', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="extra_prefix" id="extra_prefix" value="{{ old('extra_prefix', '') }}">

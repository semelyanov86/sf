                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.users.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="operations_number" id="operations_number" value="{{ old('operations_number', '10') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="budget_day_start" id="budget_day_start" value="{{ old('budget_day_start', '1') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="primary_currency" id="primary_currency" value="{{ old('primary_currency', '1') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="timezone" id="timezone" value="{{ old('timezone', 'Europe/Moscow') }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="email_notify" id="email_notify" value="1" {{ old('email_notify', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="mail_time" id="mail_time" value="{{ old('mail_time') }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="sms_notify" id="sms_notify" value="1" {{ old('sms_notify', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="sms_time" id="sms_time" value="{{ old('sms_time') }}">

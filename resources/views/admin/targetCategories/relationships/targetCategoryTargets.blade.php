...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-targetCategoryTargets">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-targetCategoryTargets:not(.ajaxTable)').DataTable({ buttons: dtButtons })

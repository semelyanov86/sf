    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.targets.update", [$target->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_name') ? 'is-invalid' : '' }}" type="text" name="target_name" id="target_name" value="{{ old('target_name', $target->target_name) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('amount') ? 'is-invalid' : '' }}" type="number" name="amount" id="amount" value="{{ old('amount', $target->amount) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('first_pay_date') ? 'is-invalid' : '' }}" type="text" name="first_pay_date" id="first_pay_date" value="{{ old('first_pay_date', $target->first_pay_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monthly_pay_amount') ? 'is-invalid' : '' }}" type="number" name="monthly_pay_amount" id="monthly_pay_amount" value="{{ old('monthly_pay_amount', $target->monthly_pay_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('pay_to_date') ? 'is-invalid' : '' }}" type="text" name="pay_to_date" id="pay_to_date" value="{{ old('pay_to_date', $target->pay_to_date) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('target_is_done') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="target_is_done" id="target_is_done" value="1" {{ $target->target_is_done || old('target_is_done', 0) === 1 ? 'checked' : '' }}>

...
{ data: 'id', name: 'id' },
{ data: 'target_category_target_category_name', name: 'target_category.target_category_name' },
{ data: 'currency_code', name: 'currency.code' },
{ data: 'account_from_name', name: 'account_from.name' },
{ data: 'user_name', name: 'user.name' },
{ data: 'target_type', name: 'target_type' },
{ data: 'target_name', name: 'target_name' },
{ data: 'target_status', name: 'target_status' },

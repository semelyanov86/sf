    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.operations.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('done_at') ? 'is-invalid' : '' }}" type="text" name="done_at" id="done_at" value="{{ old('done_at') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('related_transactions') ? 'is-invalid' : '' }}" name="related_transactions" id="related_transactions">{{ old('related_transactions') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cal_repeat') ? 'is-invalid' : '' }}" type="number" name="cal_repeat" id="cal_repeat" value="{{ old('cal_repeat', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('remind_operation') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="remind_operation" id="remind_operation" value="1" {{ old('remind_operation', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_calendar') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_calendar" id="is_calendar" value="1" {{ old('is_calendar', 0) == 1 ? 'checked' : '' }}>
...
<script>
    ...
    url: '{{ route('admin.operations.storeMedia') }}',
    maxFilesize: 2, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {

    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.users.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('operations_number') ? 'is-invalid' : '' }}" type="number" name="operations_number" id="operations_number" value="{{ old('operations_number', '10') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('budget_day_start') ? 'is-invalid' : '' }}" type="number" name="budget_day_start" id="budget_day_start" value="{{ old('budget_day_start', '1') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('primary_currency') ? 'is-invalid' : '' }}" type="number" name="primary_currency" id="primary_currency" value="{{ old('primary_currency', '1') }}" step="1" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('google_sync') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="google_sync" id="google_sync" value="1" {{ old('google_sync', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('email_notify') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="email_notify" id="email_notify" value="1" {{ old('email_notify', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('mail_days_before') ? 'is-invalid' : '' }}" name="mail_days_before" id="mail_days_before" required>
                    ...
                    @foreach(\Domains\Users\Enums\MailDaysBeforeEnum::getInstances() as $key => $label)
                        <option value="{{ $label->value }}" {{ (int) old('mail_days_before', 0) === $label->value ? 'selected' : '' }}>{{ $label->description }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('mail_time') ? 'is-invalid' : '' }}" type="text" name="mail_time" id="mail_time" value="{{ old('mail_time') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('sms_notify') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="sms_notify" id="sms_notify" value="1" {{ old('sms_notify', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('sms_days_before') ? 'is-invalid' : '' }}" name="sms_days_before" id="sms_days_before" required>
                    ...
                    @foreach(\Domains\Users\Enums\SmsDayBefore::getInstances() as $key => $label)
                        <option value="{{ $label->value }}" {{ (int) old('sms_days_before', 0) === $label->value ? 'selected' : '' }}>{{ $label->description }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('sms_time') ? 'is-invalid' : '' }}" type="text" name="sms_time" id="sms_time" value="{{ old('sms_time') }}">

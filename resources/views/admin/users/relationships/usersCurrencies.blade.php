...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-usersCurrencies">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($currencies as $key => $currency)
                        <tr data-entry-id="{{ $currency->id }}">
                            ...
                            <td>
                                @foreach($currency->users as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-usersCurrencies:not(.ajaxTable)').DataTable({ buttons: dtButtons })

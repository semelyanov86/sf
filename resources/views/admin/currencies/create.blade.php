    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.currencies.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('course') ? 'is-invalid' : '' }}" type="number" name="course" id="course" value="{{ old('course', '1') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('update_date') ? 'is-invalid' : '' }}" type="text" name="update_date" id="update_date" value="{{ old('update_date') }}">
